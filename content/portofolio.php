...
$queryPortofolios = mysqli_query($koneksi, "SELECT DISTINCT categories.name, 
categories.id as id_category, portofolios.* FROM portofolios 
LEFT JOIN categories ON categories.id = portofolios.id_category 
WHERE is_active=1 ORDER BY portofolios.id DESC ");
        ...
        <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-<?php echo $row['id_category'] ?>">
            ...
            <div class="portfolio-info">
              ...
              <a href="admin/upload/<?php echo $row['image'] ?>" title="<?php echo $row['id_category'] ?>"
