...
if (isset($_POST['simpan'])) {
  ...
  if ($id) {
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO about (title, content, is_active, image) VALUES('$title', '$content', '$is_active', '$image_name')");
    if ($insert) {
        ...
        <div class="card-body">
          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="title" placeholder="Masukkan title Anda" required
                value="<?php echo ($id) ? $rowEdit['title'] : '' ?>">
            </div>
            <div class="mb-3">
              <label for="">Content</label>
              <textarea name="content" id="summernote" class="
                form-control"><?php echo ($id) ? $rowEdit['content'] : '' ?></textarea>
            </div>
            <div class="mb-3">
