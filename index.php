...
$queryAbout = mysqli_query($koneksi, "SELECT * FROM about WHERE is_active ORDER BY id DESC");
$rowAbout   = mysqli_fetch_assoc($queryAbout);

$queryClients = mysqli_query($koneksi, "SELECT * FROM clients WHERE is_active ORDER BY id DESC");
